...
const HomePage = () => {
    return (
        ...
        <section className={`py-10 flex-wrap lg:px-0 px-4 lg:flex-nowrap flex items-center justify-between gap-5 container mx-auto`}>
            ...
            <Image src={`/e-learning/images/hero-banner.webp`} alt="Hero Image" width={550} height={720} className="rounded-lg"/>
        </section>
    ...
    list:[
        {
            ...
            category:'Marketing',
            image:`/e-learning/images/course.webp`,
            price:'$88',
            lessons:"13 Lessons",
...
const data:IUnlock = {
    ...
    image:`/e-learning/images/unlock.webp`,
    image_alt:'image',
    subData:{
